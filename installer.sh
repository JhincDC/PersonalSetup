...
fonts="ttf-dejavu noto-fonts noto-fonts-emoji noto-fonts-cjk ttf-droid ttf-freefont ttf-liberation ttf-opensans ttf-roboto ttf-roboto-mono ttf-jetbrains-mono ttf-ms-fonts otf-latinmodern-math ttf-gentium-plus adobe-source-code-pro-fonts ttf-ubuntu-font-family ttf-cascadia-code"
